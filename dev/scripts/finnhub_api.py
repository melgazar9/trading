# -*- coding: utf-8 -*-
"""
Created on Wed Dec 30 16:48:35 2020
...
r = requests.post('https://finnhub.io/api/v1/webhook/add?token=' + API_KEY, json={'event': 'earnings', 'symbol': 'AAPL'})
res = r.json()
print(res)

webhook_id = res['id']
# List webhook
r = requests.get('https://finnhub.io/api/v1/webhook/list?token=' + API_KEY)
res = r.json()

print(res)

#Delete webhook
r = requests.post('https://finnhub.io/api/v1/webhook/delete?token=' + API_KEY, json={'id': webhook_id})
res = r.json()
print(res)
